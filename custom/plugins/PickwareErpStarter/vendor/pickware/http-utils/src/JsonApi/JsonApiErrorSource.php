...
{
    /**
     * @var string|null A JSON Pointer [RFC6901] to the associated entity in the request document
     * [e.g. "/data" for a primary data object, or "/data/attributes/title" for a specific attribute].
     */
    private $pointer;

    /**
     * @var string|null A string indicating which URI query parameter caused the error.
     */
    private $parameter;

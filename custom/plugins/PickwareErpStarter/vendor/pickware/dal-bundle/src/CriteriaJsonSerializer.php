...
class CriteriaJsonSerializer
{
    ...
    public function deserializeFromArray(
        ...
        // This is a direct copy of method 'fromArray' of class RequestCriteriaBuilder in the Shopware Framework, except
        // for the following methods:
        //      - addOffset() and its call
        ...
        if (isset($payload['associations'])) {
            foreach ($payload['associations'] as $propertyName => $association) {
                ...
                $this->deserializeFromArray($association, $nested, $ref, $context);
            }
        }
    ...
    private function addOffset(array $payload, Criteria $criteria, SearchRequestException $searchRequestException): void
    {
        ...
        if ($this->maxLimit > 0 && $offset > $this->maxLimit) {
            $searchRequestException->add(new QueryLimitExceededException($this->maxLimit, $offset), '/query');

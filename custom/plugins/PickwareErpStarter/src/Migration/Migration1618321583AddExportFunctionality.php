        ...
        $connection->executeUpdate(
            '
                INSERT INTO `pickware_erp_import_export_profile` (
                    ...
                    :profileTechnicalName1,
                    NOW()
                ), (
                    :profileTechnicalName2,
                    NOW()
                ), (
                    :profileTechnicalName3,
                    NOW()
                );
            ',
            [
                'profileTechnicalName1' => 'stock-per-product',
                'profileTechnicalName2' => 'stock-per-warehouse',
                'profileTechnicalName3' => 'stock-per-stock-location',
            ]
        );
    }

...
use Pickware\PickwareErpStarter\Installation\Steps\UpsertReorderMailTemplateInstallationStep;
...
class Migration1617018765UpdateReorderMailEventAction extends MigrationStep
{
    ...
    public function update(Connection $connection): void
    {
        $mailTemplateTypeResult = $connection->fetchAssociative(
            ...
            [
                'technicalName' => UpsertReorderMailTemplateInstallationStep::MAIL_TEMPLATE_TYPE_TECHNICAL_NAME,
            ]
        );

...
class ImportExportDefinition extends EntityDefinition
{
    ...
    public const EVENT_LOADED = self::ENTITY_NAME . '.loaded';
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection(
            [
                ...
                (new BoolField('is_download_ready', 'isDownloadReady'))->addFlags(new Runtime()),
                (new DateTimeField('started_at', 'startedAt')),
                (new DateTimeField('completed_at', 'completedAt')),
                new JsonSerializableObjectField('errors', 'errors', JsonApiErrors::class, function ($value) {
                    return new JsonApiErrors($value);
                }),

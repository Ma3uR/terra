...
class PageFormat implements JsonSerializable
{
     ...
     */
    public function __construct(string $description, RectangleDimensions $size)
    {
    ...
    /**
     * @param string $dinName, like 'A4', 'B5'
     * @return self
     */
    public static function createDinPageFormat(string $dinName): self
    {
        ...
        $class = intval($matches[2]); // The number of the DIN name, e.g. 4 for A4

...
class ShipmentConfigDescription
{
    /**
     * @var array
     */
    private $shipmentConfigDescription;
    ...
    {
        $this->shipmentConfigDescription = $shipmentConfigDescription;
    }

    public function getDefaultValues(): array
    {
        return self::getDefaultValuesFromConfigDescription($this->shipmentConfigDescription);
    }
    ...
    {
        return $this->shipmentConfigDescription;
    }
}

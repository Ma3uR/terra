...
use Crsw\CleverReachOfficial\Core\Infrastructure\Interfaces\Required\Configuration as ConfigInterface;
...
class Configuration
{
    ...
    {
        static::getInstance()->setIsDefaultLoggerEnabled($status);
    }

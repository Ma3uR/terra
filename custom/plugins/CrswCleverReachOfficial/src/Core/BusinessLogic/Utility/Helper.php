...
namespace Crsw\CleverReachOfficial\Core\BusinessLogic\Utility;
...
class Helper
{
     ...
     *
     * @param \Crsw\CleverReachOfficial\Core\BusinessLogic\Entity\Recipient $recipient Recipient instance

...
class TagCollection implements \Iterator, \Countable, Serializable
{
     ...
     * List of tag objects.
     *
     * @var \Crsw\CleverReachOfficial\Core\BusinessLogic\Entity\AbstractTag[]
     */
    private $tags;
    /**
     * Current position.
     ...
     *
     * Accepts list of @see \Crsw\CleverReachOfficial\Core\BusinessLogic\Entity\AbstractTag
     * instances to start with.
     *
     * @param \Crsw\CleverReachOfficial\Core\BusinessLogic\Entity\AbstractTag[] $tags List of tag objects.
     */
     ...
     *
     * @param \Crsw\CleverReachOfficial\Core\BusinessLogic\Entity\AbstractTag|null $tag Tag that needs to be added to a list.
     *
     * @return $this
     *
     */
     ...
     *
     * @param \Crsw\CleverReachOfficial\Core\BusinessLogic\Entity\TagCollection|null $tagCollection A collection of tags to add to
     * current collection.
     *
     * @return $this
     */
     ...
     *
     * @param \Crsw\CleverReachOfficial\Core\BusinessLogic\Entity\AbstractTag|string $needle The searched tag.
     *
     * @return bool
     ...
     *
     * @param \Crsw\CleverReachOfficial\Core\BusinessLogic\Entity\TagCollection|null $tagCollection Tag collection to merge.
     *
     * @return $this
     */
     ...
     *
     * @param \Crsw\CleverReachOfficial\Core\BusinessLogic\Entity\TagCollection|null $tagCollection A collection of tags to be removed.
     *
     * @return $this
     */
        ...
        $this->tags = array_values(
            array_udiff(
                ...
                function ($first, $second) {
                    /** @var \Crsw\CleverReachOfficial\Core\BusinessLogic\Entity\AbstractTag $first */
                    /** @var \Crsw\CleverReachOfficial\Core\BusinessLogic\Entity\AbstractTag $second */
     ...
     * modified.
     *
     * @param \Crsw\CleverReachOfficial\Core\BusinessLogic\Entity\TagCollection|null $tagCollection A tag collection to compare against.
     *
     * @return $this
     ...
     *
     * @return \Crsw\CleverReachOfficial\Core\BusinessLogic\Entity\AbstractTag[]
     ...
     * Sets tags.
     *
     * @param \Crsw\CleverReachOfficial\Core\BusinessLogic\Entity\AbstractTag[] $tags
     */
